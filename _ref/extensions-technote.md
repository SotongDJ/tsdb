...
**Version:** 0.4 Draft
**Date:** 2026-04-27
**Scope:** Six file formats (`atsv`, `rtsv`, `ptsv`, `qtsv`, `ftsv`, `dtsv`), five running modes (`--relate`, `--plane`, `--query`, `--filter`, `--show`), canonical array values with per-element expansion in `ptsv` / `ord.ptv`, and the v0.5 numeric-collation companion plane index.
